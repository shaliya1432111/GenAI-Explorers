  ...
  return (
    <div onClick={handleClick} className="group cursor-pointer">
      ...
      <div className="relative overflow-hidden rounded-xl mb-3">
        ...
        {/* Thumbnail Image */}
        <div className="relative aspect-video bg-ai-card overflow-hidden">
          <img
            src={getThumbnail()}
            alt={video.title}
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20">
            <div className="bg-ai-blue/90 backdrop-blur-sm rounded-full p-4 transform group-hover:scale-110 transition-transform duration-300 shadow-ai-glow">
          ...
          <div className="absolute top-2 left-2 z-20">
            <span className="px-3 py-1 bg-gradient-to-r from-ai-blue to-ai-purple rounded-full text-xs font-bold text-white shadow-lg">
              {video.category}
            </span>
          </div>
        </div>
        ...
        <div className="absolute inset-0 rounded-xl border-2 border-transparent group-hover:border-ai-blue/50 transition-all duration-300 pointer-events-none"></div>
      </div>
      ...
      <div className="flex space-x-3">
        ...
        <div className="flex-1 min-w-0">
          {/* Title */}
          <h3 className="text-white font-semibold text-sm line-clamp-2 mb-1 group-hover:text-ai-blue transition-colors duration-300">
            {video.title}
          </h3>

          {/* Channel Name */}
          <p className="text-ai-gray text-xs mb-1 hover:text-white transition-colors duration-200">
        ...
        {/* More Options Button */}
        <button className="flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-ai-gray hover:text-white">
      ...
      {/* Hover Effect Line */}
      <div className="h-0.5 w-0 bg-gradient-to-r from-ai-blue via-ai-purple to-ai-pink group-hover:w-full transition-all duration-500 mt-3 rounded-full"></div>
    </div>
  );
};
